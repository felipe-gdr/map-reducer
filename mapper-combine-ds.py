...
for line in reader:
    ...
    if len(line) == 19:
        print "{0}\t{9}\t{1}\t{2}\t{3}\t{4}\t{5}\t{6}\t{7}\t{8}".format(line[0], line[1], line[2], line[3], line[5], line[6], line[7], line[8], line[9], 'A')
    elif len(line) == 5:
        print "{0}\t{5}\t{1}\t{2}\t{3}\t{4}".format(line[0], line[1], line[2], line[3], line[4], 'B')
